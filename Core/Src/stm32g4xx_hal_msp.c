...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* htim)
{
  ...
  if(htim->Instance==TIM1)
  {
    ...
    PC3     ------> TIM1_CH4
    */
    GPIO_InitStruct.Pin = TapeLED_PC3_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF2_TIM1;
    HAL_GPIO_Init(TapeLED_PC3_GPIO_Port, &GPIO_InitStruct);
  ...
  else if(htim->Instance==TIM3)
  {
    ...
    PC6     ------> TIM3_CH1
    */
    GPIO_InitStruct.Pin = Sounder2_PC6_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF2_TIM3;
    HAL_GPIO_Init(Sounder2_PC6_GPIO_Port, &GPIO_InitStruct);
  ...
  else if(htim->Instance==TIM8)
  {
    ...
    PC7     ------> TIM8_CH2
    */
    GPIO_InitStruct.Pin = Sounder3_PC7_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF4_TIM8;
    HAL_GPIO_Init(Sounder3_PC7_GPIO_Port, &GPIO_InitStruct);
  ...
  else if(htim->Instance==TIM20)
  {
    ...
    PC2     ------> TIM20_CH2
    */
    GPIO_InitStruct.Pin = Sounder1_PC2_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF6_TIM20;
    HAL_GPIO_Init(Sounder1_PC2_GPIO_Port, &GPIO_InitStruct);
